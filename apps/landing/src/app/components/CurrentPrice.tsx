    ...
    return (
        <Box sx={{ width: '100%', maxWidth: 640 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                <Typography sx={{ fontWeight: 700, fontSize: 20 }}>قیمت لحظه ای</Typography>
                <Image src="/icons/chart.svg" alt="" width={20} height={20} />
            </Box>
            ...
            >
                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
                    <Typography sx={{ fontWeight: 700 }}>ضایعات آهن</Typography>
                ...
                >
                    <ItemRow title="آهن سنگین" price="15,800" up />
                    <ItemRow title="پروفیل ضایعاتی" price="19,100" up={false} />
                </Box>
