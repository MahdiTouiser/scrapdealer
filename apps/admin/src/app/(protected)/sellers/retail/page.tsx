...
import RetailSellersTable, {
    RetailSeller,
} from '@/components/sellers/retail/RetailSellersTable';
...
const RetailSellers = () => {
    ...
    const [editingSeller, setEditingSeller] = useState<RetailSeller | null>(null);
    const [confirmOpen, setConfirmOpen] = useState(false);
    const [selectedId, setSelectedId] = useState<string | null>(null);
    const [rowData, setRowData] = useState<RetailSeller[]>([]); // initially empty
    ...
    const handleAddSeller = (data: Omit<RetailSeller, 'id'>) => {
        const newSeller: RetailSeller = {
            ...data,
    ...
    const handleEdit = (seller: RetailSeller) => {
        setEditMode(true);
        setEditingSeller(seller);
        handleOpen();
    };

    const handleUpdateSeller = (data: Omit<RetailSeller, 'id'>) => {
